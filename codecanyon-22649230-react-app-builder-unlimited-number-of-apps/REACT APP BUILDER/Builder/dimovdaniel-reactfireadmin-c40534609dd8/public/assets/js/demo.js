...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    reinitializeSideClose(){
        setTimeout(function() {
            console.log("Init sidemenu close demo call");
    ...
    initMaterialWizard: function(){
        ...
        console.log('initMaterialWizard');
        ...
        $('[data-toggle="wizard-radio"]').click(function(){
            ...
            if(type=='type'){
                ...
                $('#appType').val(id).change();
                //$('#appType').trigger("change");
            }
            if(type=='layout'){
                console.log("Change layout");
                $('#appLayout').val(id).change();
                //$('#appLayout').trigger("change");
            }
            console.log(id);
	...
	showNotification: function(from, align,notificationType,notificationMessage,icon){

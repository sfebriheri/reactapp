...
export default class Grid extends Component {
  ...
  renderItems = () => this.props.data.navigation.menus.map((route, index) => (
    ...
    <RkButton
        ...
        style={{ ...this.itemSize,flexDirection:"column",marginTop:20,backgroundColor:this.props.design.general.gridButtonsColor||"#273177",borderRadius: 30,opacity:0.7}}
        key={route.name}
        ...
        <RkText style={{fontSize: 14,fontWeight: "600",color:this.props.design.general.colors?this.props.design.general.colors[index % this.props.design.general.colors.length].color:"#fff"}}>{route.name}</RkText>
  </RkButton>
